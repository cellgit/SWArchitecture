...
class MvvmRxswiftMoyaVC: UIViewController {
...
extension MvvmRxswiftMoyaVC: UITableViewDataSource,UITableViewDelegate {
...
extension MvvmRxswiftMoyaVC: ViewProtocol {
